...
for a in range(0, (int(var_header) + int(var_vertex_nm) + int(var_face_nm))):
    ...
    if int(var_header) < a < (int(var_vertex_nm)+ int(var_header)+1):
        ...
        listje = []
    if (int(var_vertex_nm)+ int(var_header)) < a < (int(var_vertex_nm) + int(var_header) + int(var_face_nm)):
        if int(line[0]) ==  4:
